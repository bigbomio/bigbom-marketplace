...
function* getDefaultLanguage() {
    try {
        const result = 'en'; // yield call(checkLocalLanguage);
...
const getBrowserLanguage = () => {
    ...
    return (browserLang && (_.find(appLocales, locale => locale === browserLang.toLowerCase()) || DEFAULT_LANGUAGE)) || DEFAULT_LANGUAGE;
};
